 ...
 */
export class NoteEditingSlice implements INoteEditingSlice {
    private app: App;
    ...
    constructor(app: App, options?: Partial<NoteEditingOptions>) {
        ...
        this.contentEditor = new ContentEditor(app, this.logger);
        this.headingManager = new HeadingManager(this.logger);
        this.fileModifier = new FileModifier(app, this.logger, this.contentEditor);
